		...
		<view class="page-body uni-content-info">
			<view class="cropper-content">
				<view v-if="isShowImg" class="uni-corpper"
					:style="'width:' + cropperInitW + 'px;height:' + cropperInitH + 'px;background:#fff'">
			...
			<button class="buttons" type="primary" :disabled="isSubmit" @click="getImageInfo">确定裁剪并保存</button>
		</view>
	</view>
</template>
