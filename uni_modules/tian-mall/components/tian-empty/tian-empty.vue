<template>
	<view class="tian-empty" v-if="show" :style="{
		paddingTop: marginTop + 'rpx',
		paddingBottom: paddingBottom + 'rpx',
	}" @click="_click">
		<tian-icons :type="mode" :color="color" :size="iconSize" align="bottom">
			<text :style="{fontSize:fontSize+'rpx'}" style="margin-top: 20rpx;">{{text}}</text>
		</tian-icons>
		<view class="tian-slot-wrap">
