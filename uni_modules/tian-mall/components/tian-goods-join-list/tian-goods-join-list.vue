<template>
	<view class="goods-list-container" :class="[configs.style]">
		<unicloud-db ref="udb" v-slot:default="{data, loading, error, options,hasMore}" :collection="collection"
			@load="loadData" action="goods_miaosha,goods_member,cart_goods" :field="field+',goods_id'" :where="where"
			:options="configs" :orderby="orderby" style="height: 100%;">
