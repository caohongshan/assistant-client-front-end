<template>
	<view v-if="loading" :style="{
		...
		<view v-for="(item, index) in RectNodes" :key="'ract'+index" :class="[animation ? 'skeleton-fade' : '']" :style="{
			width: item.width + 'px', 
		...
		<view v-for="(item, index) in circleNodes" :key="'circle'+index" :class="animation ? 'skeleton-fade' : ''"
			:style="{
			width: item.width + 'px', 
			height: item.height + 'px', 
			backgroundColor: elColor, 
		...
		<view v-for="(item, index) in filletNodes" :key="'fillet'+index" :class="animation ? 'skeleton-fade' : ''"
			:style="{
			width: item.width + 'px', 
			height: item.height + 'px', 
			backgroundColor: elColor, 
